...
class ReplaceAssetsReferencesInDocSpec extends Specification {
    ...
    def setup() {
        ...
        def generatorConfig = Configuration.deriveFrom(CmdArguments.parse(["-src", srcDir] as String[]))
    ...
    def "replaces stylesheet references" () {
        ...
        when:
        AssetReferences.replaceAssetsReferencesInDoc(doc, docURI, assetSubstitutes, baseUrl)
    ...
    def "replaces image references of sort <img srcset=\"...\">" () {
        ...
        when:
        AssetReferences.replaceAssetsReferencesInDoc(doc, docURI, substitutes, baseUrl)
    ...
    def "replaces relative refs of type '#ref' in docs with path '#docURI'" (String ref, String docURI,
        ...
        when:
        AssetReferences.replaceAssetsReferencesInDoc(doc, URI.create(docURI), assetSubstitutes, baseUrl)
